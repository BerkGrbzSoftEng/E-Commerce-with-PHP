...
$menusor=$db->prepare("SELECT * FROM menu order by menu_alignment ASC");
$menusor->execute();
            ...
            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                <tr>
                 ...
                 <td><?php echo $menucek['menu_alignment'] ?></td>

                 <td><center><?php 

                  if ($menucek['menu_status']==1) {?>

                  <a href="../sql/islem.php?menu_id=<?php echo $menucek['menu_id']; ?>&menu_sts=0&menu_status=ok"><button class="btn btn-success btn-xs">Aktif</button>

                <?php }else if ($menucek['menu_status']==0) {?>

                <a href="../sql/islem.php?menu_id=<?php echo $menucek['menu_id']; ?>&menu_sts=1&menu_status=ok"><button class="btn btn-danger btn-xs">Pasif</button>
