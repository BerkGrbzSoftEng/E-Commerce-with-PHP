        ...
        <div class="x_panel">
          ...
          <div class="x_content">
            ...
            <form action="../sql/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <select id="heard" class="form-control" name="product_id" required>
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="number" id="first-name" name="product_promosyon" min="1" max="100" required="required" placeholder="Yapılcak Promosyon Yüzdesini Giriniz" class="form-control col-md-7 col-xs-12">
              </div>
            </div> 
          ...
          <div class="form-group">
            <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
              <button type="submit" name="urunpromosyonkaydet" class="btn btn-success">Kaydet</button>
            </div>
          </div>
