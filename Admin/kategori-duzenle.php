...
$kategorisor=$db->prepare("SELECT * FROM category where category_id=:category_id");
            ...
            <form action="../sql/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <input type="text" id="first-name" name="category_alignment" value="<?php echo $kategoricek['category_alignment'] ?>"  class="form-control col-md-7 col-xs-12">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
               <select id="heard" class="form-control" name="category_status" required>
                  ...
                  <option value="1" <?php echo $kategoricek['category_status'] == '1' ? 'selected=""' : ''; ?>>Aktif</option>

                  <option value="0" <?php if ($kategoricek['category_status']==0) { echo 'selected=""'; } ?>>Pasif</option>
             ...
             <input type="hidden" name="category_id" value="<?php echo $kategoricek['category_id'] ?>"> 
